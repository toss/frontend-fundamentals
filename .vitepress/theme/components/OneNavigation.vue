...
.one-navigation {
  ...
  z-index: 40; /* VitePress 사이드바는 z-index: 30이므로 그 위에 배치 */
  background-color: var(--vp-c-bg-alt);
  padding-top: var(--vp-nav-height); /* 헤더와 겹치지 않도록 상단 패딩 추가 */
}
...
@media (max-width: 768px) {
  .one-navigation {
    ...
    z-index: 100; /* 모바일에서는 더 높은 z-index 설정 */
    padding-top: 0;
  }
