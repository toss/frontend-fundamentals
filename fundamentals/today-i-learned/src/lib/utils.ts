...
// === Streak Utilities ===
export const getStreakLevel = (streak: number): keyof typeof STREAK_CONFIG.EMOJIS => {
...
export const generateRecentActivity = (days: number = APP_CONSTANTS.RECENT_ACTIVITY_DAYS): ActivityDay[] => {
